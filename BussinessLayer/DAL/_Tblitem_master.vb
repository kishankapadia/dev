...
Public MustInherit Class _Tblitem_master
	Inherits SqlClientEntity

		Public Sub New() 
			Me.QuerySource = "Tblitem_master"
			Me.MappingName = "Tblitem_master"
		End Sub
	...
	Public Function LoadAll() As Boolean
    	...
    	Return MyBase.LoadFromSql("[" + Me.SchemaStoredProcedure + "proc_Tblitem_masterLoadAll]", parameters)
	...
	Public Overridable Function LoadByPrimaryKey(ByVal Id As Integer) As Boolean
		...
		parameters.Add(_Tblitem_master.Parameters.Id, Id)

		
		Return MyBase.LoadFromSql("[" + Me.SchemaStoredProcedure + "proc_Tblitem_masterLoadByPrimaryKey]", parameters)
	...
	Public class ColumnNames
		...
		Shared Public Function ToPropertyName(ByVal columnName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(Id) = _Tblitem_master.PropertyNames.Id
				ht(Name) = _Tblitem_master.PropertyNames.Name
	...
	Public class PropertyNames
		...
		Shared Public Function ToColumnName(ByVal propertyName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(Id) = _Tblitem_master.ColumnNames.Id
				ht(Name) = _Tblitem_master.ColumnNames.Name
...
#End Region	
	...
	Protected Overrides Function GetInsertCommand() As IDbCommand
		...
		cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_Tblitem_masterInsert]" 
	...
	Protected Overrides Function GetUpdateCommand() As IDbCommand
		...
		Dim cmd As SqlCommand = New SqlCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_Tblitem_masterUpdate]" 
	...
	Protected Overrides Function GetDeleteCommand() As IDbCommand
		...
		Dim cmd As SqlCommand = New SqlCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_Tblitem_masterDelete]" 
