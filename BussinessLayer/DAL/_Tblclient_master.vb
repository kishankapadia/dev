...
Public MustInherit Class _Tblclient_master
	Inherits SqlClientEntity

		Public Sub New() 
			Me.QuerySource = "Tblclient_master"
			Me.MappingName = "Tblclient_master"
		End Sub
	...
	Public Function LoadAll() As Boolean
    	...
    	Return MyBase.LoadFromSql("[" + Me.SchemaStoredProcedure + "proc_Tblclient_masterLoadAll]", parameters)
	...
	Public Overridable Function LoadByPrimaryKey(ByVal Id As Integer) As Boolean
		...
		parameters.Add(_Tblclient_master.Parameters.Id, Id)

		
		Return MyBase.LoadFromSql("[" + Me.SchemaStoredProcedure + "proc_Tblclient_masterLoadByPrimaryKey]", parameters)
	...
	Public class ColumnNames
		...
		Shared Public Function ToPropertyName(ByVal columnName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(Id) = _Tblclient_master.PropertyNames.Id
				ht(Name) = _Tblclient_master.PropertyNames.Name
				ht(Description) = _Tblclient_master.PropertyNames.Description
				ht(Mobile_no) = _Tblclient_master.PropertyNames.Mobile_no
	...
	Public class PropertyNames
		...
		Shared Public Function ToColumnName(ByVal propertyName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(Id) = _Tblclient_master.ColumnNames.Id
				ht(Name) = _Tblclient_master.ColumnNames.Name
				ht(Description) = _Tblclient_master.ColumnNames.Description
				ht(Mobile_no) = _Tblclient_master.ColumnNames.Mobile_no
...
#End Region	
	...
	Protected Overrides Function GetInsertCommand() As IDbCommand
		...
		cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_Tblclient_masterInsert]" 
	...
	Protected Overrides Function GetUpdateCommand() As IDbCommand
		...
		Dim cmd As SqlCommand = New SqlCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_Tblclient_masterUpdate]" 
	...
	Protected Overrides Function GetDeleteCommand() As IDbCommand
		...
		Dim cmd As SqlCommand = New SqlCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_Tblclient_masterDelete]" 
